...
public class DecorExtended extends AppCompatActivity {
    private Intent intent;
    private ImageView ivHome, ivDepartments, ivAlerts, ivWishList, ivProfiles, back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_decor_extended2);
        initViews();
    }
    ...
    public void initViews() {
        ...
        ivHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DecorExtended.this, HomeScreen.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ivAlerts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DecorExtended.this, AlertsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ivDepartments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DecorExtended.this, DepartmentsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ivProfiles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DecorExtended.this, ProfileSection.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DecorExtended.this, Furniture.class);
                startActivity(intent);
                finish();
            }
        });
