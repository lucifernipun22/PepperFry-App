    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(Lighting.this, HomeScreen.class);
        ...
        ivWishList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Lighting.this, WishListFragment.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ivAlerts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Lighting.this, AlertsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ivDepartments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Lighting.this, DepartmentsActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ivProfiles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Lighting.this, ProfileSection.class);
                startActivity(intent);
                finish();
            }
        });
